...
import { Badge, List, ListItem, Typography, Container } from '@shared/ui/core';

type Props = {};

export const Resume: NextPage = ({}: Props) => {
  return (
    <main>
      ...
      <Container as="section" mb={3}>
        ...
        <List>
          <ListItem>
            ...
            <Typography variant="body">
              Магистр, Инфокоммуникационные технологии и системы связи
            </Typography>
            <Typography variant="body">2018 - 2021</Typography>
          </ListItem>
          <ListItem>
            <Typography variant="h6">
              Балтийский Федеральный Университет им. И. Канта
            ...
            <Typography variant="body">2014 - 2018</Typography>
          </ListItem>
        </List>
      </Container>
